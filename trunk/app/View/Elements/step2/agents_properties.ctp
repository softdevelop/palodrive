<div class="khung_t view_k_4" style="display: none;">
            <p>
                <select id=" id=" agent_properties_opt"="" onchange="selectAgentPropertiesOpt(this.selectedIndex);">
                    <option>All Agents</option>
                    <option>Each Agent</option>
                </select>
            </p>
            <div style="overflow:hidden;height:600px; display:none" id="agent_properties_pri">
                <div class=" id=" agent_properties_tab"="">
                    <span class="agent_properties_item_tab atvi" rel="agent_properties_GB-A1">GB-A1</span>
                    <span class="agent_properties_item_tab tab_cuoi" rel="agent_properties_GB-A2">GB-A2</span>
                    <div style="clear:both"></div>
                </div>
                <div style="overflow:scroll;height:500px;" class="agent_properties_tabs agent_properties_GB-A1">
                ...
                <div style="display:none;overflow:scroll;height:500px;" class="agent_properties_tabs agent_properties_GB-A2">
                    <table width="100%" border="0" cellspacing="15" cellpadding="0">
                        <tbody>
                            <tr>
                                <td colspan="2">Agent's Commission Rate<br><input style="height:30px;width:70px" class="input" type="text" name="data[agent][121]"></td>
