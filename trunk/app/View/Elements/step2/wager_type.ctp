            ...
            <div style="overflow:scroll;height:600px;" id="wager_type_all">
                <p>
                    ...
                    <select name="data[sportbook][default]" onchange="selectDefaultSportbook(this.selectedIndex);" id="sportbookDefault">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                        <option value="100051">Grande</option>
                        <option value="100052">BetUS</option>
                    </select>
                    &nbsp;&nbsp;Select All Sports and Wager Types&nbsp;<input type="checkbox" onclick="CheckAllSport(this);">
                </p>
                <p>
                    <strong>NFL</strong>&nbsp;&nbsp;&nbsp;SportBook:&nbsp;
                    <select name="data[sportbook][1]" onchange="selectSportBook(this);" id="sportbook_1">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][1][all]" type="checkbox" onclick="CheckAll(this, '1', 0)"></td>
                        ...
                        <tr>
                            ...
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][w_PS]" id="c_1_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][w_ML]" id="c_1_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][w_TL]" id="c_1_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][b_Parlay]" id="c_1_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][b_If_Bet]" id="c_1_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][b_Teaser]" id="c_1_p_Game_w_Teaser"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][b_Future]" id="c_1_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Game][b_prop]" id="c_1_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_1st_Half][w_PS]" id="c_1_p_1st_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_1st_Half][w_ML]" id="c_1_p_1st_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_1st_Half][w_TL]" id="c_1_p_1st_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_1st_Half][b_Parlay]" id="c_1_p_1st_Half_w_Parlay"></td>
                        ...
                        <tr>
                            ...
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_2nd_Half][w_PS]" id="c_1_p_2nd_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_2nd_Half][w_ML]" id="c_1_p_2nd_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_2nd_Half][w_TL]" id="c_1_p_2nd_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_2nd_Half][b_Parlay]" id="c_1_p_2nd_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            ...
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Quarter][w_PS]" id="c_1_p_Quarter_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Quarter][w_ML]" id="c_1_p_Quarter_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Quarter][w_TL]" id="c_1_p_Quarter_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][1][p_Quarter][b_Parlay]" id="c_1_p_Quarter_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                ...
                <p>
                    ...
                    <select name="data[sportbook][2]" onchange="selectSportBook(this);" id="sportbook_2">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][2][all]" type="checkbox" onclick="CheckAll(this, '2', 0)"></td>
                            <td class="header" width="70px;">Spread</td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Total</td>
                            <td class="header" width="70px;">Parlay</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][w_PS]" id="c_2_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][w_ML]" id="c_2_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][w_TL]" id="c_2_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][b_Parlay]" id="c_2_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][b_If_Bet]" id="c_2_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][b_Teaser]" id="c_2_p_Game_w_Teaser"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][b_Future]" id="c_2_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Game][b_prop]" id="c_2_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_1st_Half][w_PS]" id="c_2_p_1st_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_1st_Half][w_ML]" id="c_2_p_1st_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_1st_Half][w_TL]" id="c_2_p_1st_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_1st_Half][b_Parlay]" id="c_2_p_1st_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">2nd Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_2nd_Half][w_PS]" id="c_2_p_2nd_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_2nd_Half][w_ML]" id="c_2_p_2nd_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_2nd_Half][w_TL]" id="c_2_p_2nd_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_2nd_Half][b_Parlay]" id="c_2_p_2nd_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">Quarter</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Quarter][w_PS]" id="c_2_p_Quarter_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Quarter][w_ML]" id="c_2_p_Quarter_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Quarter][w_TL]" id="c_2_p_Quarter_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][2][p_Quarter][b_Parlay]" id="c_2_p_Quarter_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                ...
                <p>
                    ...
                    <select name="data[sportbook][3]" onchange="selectSportBook(this);" id="sportbook_3">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][3][all]" type="checkbox" onclick="CheckAll(this, '3', 0)"></td>
                            <td class="header" width="70px;">Spread</td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Total</td>
                            <td class="header" width="70px;">Parlay</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][w_PS]" id="c_3_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][w_ML]" id="c_3_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][w_TL]" id="c_3_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][b_Parlay]" id="c_3_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][b_If_Bet]" id="c_3_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][b_Teaser]" id="c_3_p_Game_w_Teaser"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][b_Future]" id="c_3_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Game][b_prop]" id="c_3_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_1st_Half][w_PS]" id="c_3_p_1st_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_1st_Half][w_ML]" id="c_3_p_1st_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_1st_Half][w_TL]" id="c_3_p_1st_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_1st_Half][b_Parlay]" id="c_3_p_1st_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">2nd Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_2nd_Half][w_PS]" id="c_3_p_2nd_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_2nd_Half][w_ML]" id="c_3_p_2nd_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_2nd_Half][w_TL]" id="c_3_p_2nd_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_2nd_Half][b_Parlay]" id="c_3_p_2nd_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">Quarter</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Quarter][w_PS]" id="c_3_p_Quarter_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Quarter][w_ML]" id="c_3_p_Quarter_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Quarter][w_TL]" id="c_3_p_Quarter_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][3][p_Quarter][b_Parlay]" id="c_3_p_Quarter_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                ...
                <p>
                    ...
                    <select name="data[sportbook][4]" onchange="selectSportBook(this);" id="sportbook_4">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][4][all]" type="checkbox" onclick="CheckAll(this, '4', 0)"></td>
                            <td class="header" width="70px;">Spread</td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Total</td>
                            <td class="header" width="70px;">Parlay</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][w_PS]" id="c_4_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][w_ML]" id="c_4_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][w_TL]" id="c_4_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][b_Parlay]" id="c_4_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][b_If_Bet]" id="c_4_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][b_Teaser]" id="c_4_p_Game_w_Teaser"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][b_Future]" id="c_4_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Game][b_prop]" id="c_4_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_1st_Half][w_PS]" id="c_4_p_1st_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_1st_Half][w_ML]" id="c_4_p_1st_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_1st_Half][w_TL]" id="c_4_p_1st_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_1st_Half][b_Parlay]" id="c_4_p_1st_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">2nd Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_2nd_Half][w_PS]" id="c_4_p_2nd_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_2nd_Half][w_ML]" id="c_4_p_2nd_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_2nd_Half][w_TL]" id="c_4_p_2nd_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_2nd_Half][b_Parlay]" id="c_4_p_2nd_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">Quarter</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Quarter][w_PS]" id="c_4_p_Quarter_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Quarter][w_ML]" id="c_4_p_Quarter_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Quarter][w_TL]" id="c_4_p_Quarter_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][4][p_Quarter][b_Parlay]" id="c_4_p_Quarter_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                ...
                <p>
                    ...
                    <select name="data[sportbook][8]" onchange="selectSportBook(this);" id="sportbook_8">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][8][all]" type="checkbox" onclick="CheckAll(this, '8', 0)"></td>
                            <td class="header" width="70px;">Spread</td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Total</td>
                            <td class="header" width="70px;">Parlay</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][w_PS]" id="c_8_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][w_ML]" id="c_8_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][w_TL]" id="c_8_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][b_Parlay]" id="c_8_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][b_If_Bet]" id="c_8_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][b_Teaser]" id="c_8_p_Game_w_Teaser"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][b_Future]" id="c_8_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Game][b_prop]" id="c_8_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_1st_Half][w_PS]" id="c_8_p_1st_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_1st_Half][w_ML]" id="c_8_p_1st_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_1st_Half][w_TL]" id="c_8_p_1st_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_1st_Half][b_Parlay]" id="c_8_p_1st_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">2nd Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_2nd_Half][w_PS]" id="c_8_p_2nd_Half_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_2nd_Half][w_ML]" id="c_8_p_2nd_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_2nd_Half][w_TL]" id="c_8_p_2nd_Half_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_2nd_Half][b_Parlay]" id="c_8_p_2nd_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        ...
                        <tr>
                            <td class="header">Quarter</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Quarter][w_PS]" id="c_8_p_Quarter_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Quarter][w_ML]" id="c_8_p_Quarter_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Quarter][w_TL]" id="c_8_p_Quarter_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][8][p_Quarter][b_Parlay]" id="c_8_p_Quarter_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                ...
                <p>
                    ...
                    <select name="data[sportbook][5]" onchange="selectSportBook(this);" id="sportbook_5">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][5][all]" type="checkbox" onclick="CheckAll(this, '5', 0)"></td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][w_RL]" id="c_5_p_Game_w_RL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][w_ML]" id="c_5_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][w_TL]" id="c_5_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][b_Parlay]" id="c_5_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][b_If_Bet]" id="c_5_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][b_Future]" id="c_5_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Game][b_prop]" id="c_5_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st 5 Innings</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_1st_5_Innings][w_RL]" id="c_5_p_1st_5_Innings_w_RL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_1st_5_Innings][w_ML]" id="c_5_p_1st_5_Innings_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_1st_5_Innings][w_TL]" id="c_5_p_1st_5_Innings_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_1st_5_Innings][b_Parlay]" id="c_5_p_1st_5_Innings_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                        <tr>
                            ...
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Last_4_Innings][w_RL]" id="c_5_p_Last_4_Innings_w_RL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Last_4_Innings][w_ML]" id="c_5_p_Last_4_Innings_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Last_4_Innings][w_TL]" id="c_5_p_Last_4_Innings_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][5][p_Last_4_Innings][b_Parlay]" id="c_5_p_Last_4_Innings_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                ...
                <p>
                    ...
                    <select name="data[sportbook][7]" onchange="selectSportBook(this);" id="sportbook_7">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][7][all]" type="checkbox" onclick="CheckAll(this, '7', 0)"></td>
                            <td class="header" width="70px;">Spread</td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Total</td>
                            <td class="header" width="70px;">Parlay</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][w_PS]" id="c_7_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][w_ML]" id="c_7_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][w_TL]" id="c_7_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][b_Parlay]" id="c_7_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][b_If_Bet]" id="c_7_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][b_Future]" id="c_7_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_Game][b_prop]" id="c_7_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Period</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_1st_Period][w_PS]" id="c_7_p_1st_Period_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_1st_Period][w_ML]" id="c_7_p_1st_Period_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_1st_Period][w_TL]" id="c_7_p_1st_Period_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_1st_Period][b_Parlay]" id="c_7_p_1st_Period_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                        <tr>
                            ...
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_2nd_Period][w_PS]" id="c_7_p_2nd_Period_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_2nd_Period][w_ML]" id="c_7_p_2nd_Period_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_2nd_Period][w_TL]" id="c_7_p_2nd_Period_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_2nd_Period][b_Parlay]" id="c_7_p_2nd_Period_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                        <tr>
                            ...
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_3rd_Period][w_PS]" id="c_7_p_3rd_Period_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_3rd_Period][w_ML]" id="c_7_p_3rd_Period_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_3rd_Period][w_TL]" id="c_7_p_3rd_Period_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][7][p_3rd_Period][b_Parlay]" id="c_7_p_3rd_Period_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                ...
                <p>
                    ...
                    <select name="data[sportbook][9]" onchange="selectSportBook(this);" id="sportbook_9">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][9][all]" type="checkbox" onclick="CheckAll(this, '9', 0)"></td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Parlay</td>
                            <td class="header" width="70px;">If Bet</td>
                            <td class="header" width="70px;">Future</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_Game][w_ML]" id="c_9_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_Game][b_Parlay]" id="c_9_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_Game][b_If_Bet]" id="c_9_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_Game][b_Future]" id="c_9_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_Game][b_prop]" id="c_9_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_1st_Half][w_ML]" id="c_9_p_1st_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_1st_Half][b_Parlay]" id="c_9_p_1st_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                        <tr>
                            <td class="header">2nd Half</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_2nd_Half][w_ML]" id="c_9_p_2nd_Half_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][9][p_2nd_Half][b_Parlay]" id="c_9_p_2nd_Half_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                ...
                <p>
                    ...
                    <select name="data[sportbook][6]" onchange="selectSportBook(this);" id="sportbook_6">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][6][all]" type="checkbox" onclick="CheckAll(this, '6', 0)"></td>
                            <td class="header" width="70px;">Spread</td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Total</td>
                            <td class="header" width="70px;">Parlay</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][w_PS]" id="c_6_p_Game_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][w_ML]" id="c_6_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][w_TL]" id="c_6_p_Game_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][b_Parlay]" id="c_6_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][b_If_Bet]" id="c_6_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][b_Future]" id="c_6_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Game][b_prop]" id="c_6_p_Game_w_prop"></td>
                        </tr>
                        <tr>
                            <td class="header">1st 5 Innings</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_1st_5_Innings][w_PS]" id="c_6_p_1st_5_Innings_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_1st_5_Innings][w_ML]" id="c_6_p_1st_5_Innings_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_1st_5_Innings][w_TL]" id="c_6_p_1st_5_Innings_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_1st_5_Innings][b_Parlay]" id="c_6_p_1st_5_Innings_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                        <tr>
                            <td class="header">Last 4 Innings</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Last_4_Innings][w_PS]" id="c_6_p_Last_4_Innings_w_PS"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Last_4_Innings][w_ML]" id="c_6_p_Last_4_Innings_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Last_4_Innings][w_TL]" id="c_6_p_Last_4_Innings_w_TL"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][6][p_Last_4_Innings][b_Parlay]" id="c_6_p_Last_4_Innings_w_Parlay"></td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                            <td align="center" style="color:red;">X</td>
                        </tr>
                ...
                <p>
                    ...
                    <select name="data[sportbook][10]" onchange="selectSportBook(this);" id="sportbook_10">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][10][all]" type="checkbox" onclick="CheckAll(this, '10', 0)"></td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Parlay</td>
                            <td class="header" width="70px;">If Bet</td>
                            <td class="header" width="70px;">Future</td>
                        ...
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][10][p_Game][w_ML]" id="c_10_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][10][p_Game][b_Parlay]" id="c_10_p_Game_w_Parlay"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][10][p_Game][b_If_Bet]" id="c_10_p_Game_w_If_Bet"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][10][p_Game][b_Future]" id="c_10_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][10][p_Game][b_prop]" id="c_10_p_Game_w_prop"></td>
                        </tr>
                    </tbody>
                </table>
                <p>
                    <strong>All Golf</strong>&nbsp;&nbsp;&nbsp;SportBook:&nbsp;
                    <select name="data[sportbook][11]" onchange="selectSportBook(this);" id="sportbook_11">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][11][all]" type="checkbox" onclick="CheckAll(this, '11', 0)"></td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Future</td>
                            <td class="header" width="70px;" style="background-color:#dcdcdc;">Prop</td>
                        </tr>
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][11][p_Game][w_ML]" id="c_11_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][11][p_Game][b_Future]" id="c_11_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][11][p_Game][b_prop]" id="c_11_p_Game_w_prop"></td>
                        </tr>
                    </tbody>
                </table>
                <p>
                    <strong>Tennis</strong>&nbsp;&nbsp;&nbsp;SportBook:&nbsp;
                    <select name="data[sportbook][12]" onchange="selectSportBook(this);" id="sportbook_12">
                        <option value=""></option>
                        <option value="100048">5Dimes</option>
                        <option value="100049">Pinnacle</option>
                        <option value="100050">CRIS</option>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="player_limit">
                    <tbody>
                        <tr>
                            <td class="header" nowrap="">Select All&nbsp;<input value="1" name="data[c][12][all]" type="checkbox" onclick="CheckAll(this, '12', 0)"></td>
                            <td class="header" width="70px;">ML</td>
                            <td class="header" width="70px;">Future</td>
                            <td class="header" width="70px;" style="background-color:#dcdcdc;">Prop</td>
                        </tr>
                        <tr>
                            <td class="header">Game</td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][12][p_Game][w_ML]" id="c_12_p_Game_w_ML"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][12][p_Game][b_Future]" id="c_12_p_Game_w_Future"></td>
                            <td align="center"><input value="1" type="checkbox" name="data[c][12][p_Game][b_prop]" id="c_12_p_Game_w_prop"></td>
                        </tr>
                    </tbody>
                </table>
                <p>
