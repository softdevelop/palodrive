...
-- Schema palodrive
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `palodrive` ;
...
-- -----------------------------------------------------
-- Table `palodrive`.`horses_park`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `palodrive`.`horses_park` ;

CREATE TABLE IF NOT EXISTS `palodrive`.`horses_park` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `palodrive`.`horses_wager_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `palodrive`.`horses_wager_type` ;

CREATE TABLE IF NOT EXISTS `palodrive`.`horses_wager_type` (
  `id` INT NOT NULL,
  `wsp` TINYINT NULL,
  `exacta` TINYINT NULL,
  `trifecta` TINYINT NULL,
  ...
  CONSTRAINT `fk_horses_wager_type_horses_park1`
    ...
    REFERENCES `palodrive`.`horses_park` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `palodrive`.`horses_wager_limit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `palodrive`.`horses_wager_limit` ;

CREATE TABLE IF NOT EXISTS `palodrive`.`horses_wager_limit` (
  `id` INT NOT NULL,
  `wsp` TINYINT NULL,
  `exacta` TINYINT NULL,
  `trifecta` TINYINT NULL,
